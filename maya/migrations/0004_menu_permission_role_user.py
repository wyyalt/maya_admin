# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-23 14:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, to='maya.Permission', verbose_name='拥有权限')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, to='maya.Role', verbose_name='拥有角色')),
            ],
        ),
    ]
