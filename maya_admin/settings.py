"""
Django settings for maya_admin project.
...
SECRET_KEY = 'e0nddh@9x3m8x$8uh^4^vw@!9k4k*8v)qbz5xh1%s+a4or+$a8'
...
MIDDLEWARE = [
    ...
    'maya.middleware.rbac.RbacMiddleware'
]

ROOT_URLCONF = 'maya_admin.urls'
...
WSGI_APPLICATION = 'maya_admin.wsgi.application'
